...
mysql_select_db($database_olshop, $olshop);	
	...
	$query_rs_orders_print = "SELECT * FROM orders, kustomer, kota WHERE orders.id_kustomer = kustomer.id_kustomer AND kustomer.id_kota = kota.id_kota AND tgl_order";
