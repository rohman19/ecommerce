...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE produk SET gambar=%s WHERE produk_id=%s",
...
mysql_select_db($database_olshop, $olshop);
$query_rs_gambar = sprintf("SELECT * FROM produk WHERE produk_id = %s", GetSQLValueString($colname_rs_gambar, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="100%" height="204">
    ...
    <tr valign="baseline">
      ...
      <td width="860"><img src="gambar/<?php echo $row_rs_gambar['gambar']; ?>" class="img-rounded img-thumbnail" alt="image" width="41%" height="234" /></td>
    </tr>
  </table>
  <input type="hidden" name="MM_update" value="form1" />
  <input type="hidden" name="produk_id" value="<?php echo $row_rs_gambar['produk_id']; ?>" />
</form>
<p>&nbsp;</p>
</body>
</html>
