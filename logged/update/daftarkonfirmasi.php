...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE konfirmasi SET id_kustomer=%s, subjek=%s, pesan=%s, tanggal=%s WHERE id_hubungi=%s",
                       ...
                       GetSQLValueString($_POST['id_konfirmasi'], "int"));
...
mysql_select_db($database_olshop, $olshop);
$query_rs_pesan = sprintf("SELECT * FROM konfirmasi, kustomer WHERE id_konfirmasi = %s AND konfirmasi.id_kustomer = kustomer.id_kustomer", GetSQLValueString($colname_rs_pesan, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="100%" height="295">
    ...
    <tr valign="baseline">
      ...
      <td><input type="date" name="tanggal" value="<?php echo htmlentities($row_rs_pesan['tanggal'], ENT_COMPAT, 'utf-8'); ?>" size="32"  class="form-control"/></td>
        ...
        <tr valign="baseline">
      <td height="40" align="right" valign="top" nowrap="nowrap"><div align="left">Gambar</div></td>
      <td><input type="file" name="gambar" value="<?php echo htmlentities ($row_rs_pesan['gambar'], ENT_COMPAT, 'utf-8'); ?>" size="32"  class="form-control"/></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="id_konfirmasi" value="<?php echo $row_rs_pesan['id_konfirmasi']; ?>" />
</form>
