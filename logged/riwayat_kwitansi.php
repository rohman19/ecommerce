                      ...
                      <table width="467" height="97" class="table table-striped">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php if ($row_rs_detail['status_order'] == 'Belum Lunas') {
        ...
        <div class="col-md-6">
         <div class="page-header">
            ...
            <div class="row">
                ...
                <div class="col-md-4"><img src="gambar/bank/mandiri.png" class="img-responsive" /><br /><strong>Mandiri <br />09.8099.00.1</strong><br />A/n   : Rohmad Safi'i</div>
            </div>
